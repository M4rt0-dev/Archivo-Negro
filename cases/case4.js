...
var CASE4 = {
  title: "Senal Perdida",
  year: "2089",
  setting: "Estacion orbital Helios-3, orbita baja terrestre",
  tagline: "Siete tripulantes muertos. Un experimento sin consentimiento. El cientifico escapo solo.",
  intro: "14 de enero de 2089. La estacion Helios-3 fue declarada perdida. Cero supervivientes.\nCausa oficial: fallo en cadena de soporte vital.\nSeis meses despues, la sonda de recuperacion Artemis encontro la caja negra.\nEsta sesion de recuperacion contiene lo que queda. Descubre que hizo el Dr. Cassius.",
  ...
  hints: [
    "Lee la bitacora de Oretz. Menciona a su hija de 9 anos. El nombre de la hija es la primera clave.",
    "cd bitacoras → unlock ultimo_mensaje_oretz.enc LYRA — El mensaje revela el codigo admin de la estacion.",
    "Usa 'examine dao' para entender por que el orden de los apagados fue la primera pista. Un fallo real sigue el orden inverso.",
    "Usa 'profile oretz' y lee su bitacora completa. Supo lo que estaba pasando antes que nadie y lo documento todo.",
    "Usa 'examine oretz' para entender su cadena de decisiones. Envio alertas a Tierra, pero el Consorcio controlo la respuesta.",
    "Usa 'cd bitacoras' y lee diario_tecnico.txt. Novak detecto que los sensores de O2 estaban falsificados el 8 de enero.",
    "Usa 'examine novak' para entender la cadena de descubrimientos. Ella fue la primera en ver la manipulacion de sensores.",
    "Usa 'examine ntx7' para entender el agente quimico. Luego 'examine cero' para ver la diferencia entre el protocolo oficial y el real.",
    "cd experimentos → unlock resultados_ocultos.enc CERO — Los resultados muestran el plan de Cassius.",
    "Usa 'cd tripulacion' → usa 'search tripulacion medico' para ver los sintomas dia a dia en cada miembro del modulo 3.",
    "Usa 'examine control tierra' para entender por que las alertas de Oretz fueron ignoradas. El operador no sabia lo que transmitia.",
    "Usa 'search doctor experimento' para el perfil real de Cassius del Consorcio.",
    "Usa 'search consorcio contrato' para leer el contrato ORION. Exige datos de 'sujetos reales'. La tripulacion era el experimento.",
    "Usa 'search consorcio transmision' para leer el mensaje del Consorcio autorizando el protocolo PROMETEO. Es la prueba institucional del crimen.",
    ...
    "Usa 'examine 0322' para entender el momento exacto en que Cassius apago el reciclaje global de toda la estacion.",
    ...
    "Usa 'examine orion' — el nombre de la estacion privada adonde huyo Cassius es la contrasena del veredicto final.",
    "El punto de destino de la capsula de Cassius es la ultima clave. Usa 'examine capsula'.",
  ...
  map: "HELIOS-3 — ESTACION ORBITAL\n" +
    "Orbita: 387 km. Inclinacion: 28.5°\n" +
    "═══════════════════════════════════════════════════\n" +
    "  ┌────────────────┐  ┌────────────────┐\n" +
    ...
    "  └────────────┘       └───────────────────┘\n" +
    "  ┌────────────┐       ┌───────────────────┐\n" +
    "  │  CAPSULA   │       │  COMUNICACIONES   │\n" +
    "  │ EMERGENCIA │       │  (transm. Tierra) │\n" +
    "  └────────────┘       └───────────────────┘\n" +
    "  ★ ORION-447: Estacion privada del Consorcio (destino de Cassius)",
  profiles: {
    oretz: "COMANDANTE YAEL ORETZ — Victima (lider de la tripulacion)\nEdad: 41. Israelita. Piloto de orbita. Comandante desde 2085.\nHija: Lyra Oretz, 9 anos (en Tierra, en custodia del padre).\nDescubrio que el experimento CERO no era lo que les habian dicho.\nIntento cerrar el experimento manualmente la noche del 13 de enero.\nMurio en Helios-3 la madrugada del 14 de enero de 2089.",
    cassius: "DR. FENN CASSIUS — Principal responsable\nEdad: 48. Britanico. Neurocientifico y farmacologista.\nEspecialidad declarada: adaptacion del sistema nervioso en microgravedad.\nEspecialidad real: desarrollo de agentes neurotroficos para control militar.\nContratado por el Consorcio Artemis con pleno conocimiento de la metodologia real.\nEvacu\u00f3 la estacion en capsula personal a las 01:00. Fue detenido en ORION-447 en julio de 2089.",
    novak: "ING. PETRA NOVAK — Victima (ingenieria de sistemas)\nEdad: 35. Checa. Especialidad: sistemas de soporte vital y monitorizacion atmosferica.\nDescubrio que alguien habia falsificado las lecturas de O2 del modulo 3.\nInformo a Oretz el 12 de enero. No pudo impedirlo.\nMurio en Helios-3 la madrugada del 14 de enero de 2089.",
    dao: "OFICIAL SEREN DAO — Investigadora\nEdad: 29. Mision de recuperacion Artemis, sonda enviada 6 meses despues.\nFue la primera en revisar la caja negra y los archivos de la estacion.\nDocumento el orden exacto de los apagados: sensores primero, reciclaje despues, alarma al final.\nEse orden inverso al fallo tecnico normal fue lo que la hizo sospechar.",
    consorcio: "CONSORCIO ARTEMIS — Complice institucional\nOrganizacion de investigacion privada con contratos de defensa con gobiernos de 12 naciones.\nFinanciaba el programa NTX-7 (agente neurotrofico) para uso militar.\nConocia y autorizo la metodologia real del experimento CERO.\nFue procesado en 2090 bajo el Tratado de La Haya Espacial, articulo 32."
  },
  examine: {
    ntx7: "El agente NTX-7 es el compuesto neurotrofico sintetico que Cassius estaba probando en la tripulacion.\nFue administrado via el sistema de reciclaje atmosferico de la estacion.\nEn el sistema de ventilacion a dosis de 0.003 mg por metro cubico, actua de forma acumulativa.\nEfecto a los 6 dias: lentitud cognitiva. A los 10 dias: deterioro grave. Sin antidoto conocido.",
    cero: "El experimento CERO era el nombre de codigo de la investigacion de Cassius.\nEl protocolo oficial declaraba 'estudio de adaptacion del SN en microgravedad'.\nEl protocolo real: administracion de NTX-7 a la tripulacion sin su consentimiento.\nEl Consorcio lo sabia y lo aprobo con 'plena autorizacion ejecutiva'.",
    reciclaje: "El sistema de reciclaje atmosferico es el corazon de la supervivencia en la estacion.\nRecicla el CO2 y mantiene los niveles de O2 en todos los modulos.\nCassius tuvo acceso completo a ese sistema como investigador principal.\nApagarlo es una sentencia de muerte para toda la tripulacion.",
    capsula: "La capsula de emergencia personal fue activada por Cassius a las 01:00 del 14 de enero.\nEs la unica capsula de evacuacion individual de la estacion. Estaba reservada para el comandante.\nCassius la uso 15 minutos despues de confirmar la muerte de todos los tripulantes.\nDestino de la capsula: estacion privada ORION-447 del Consorcio Artemis.",
    prometeo: "El nombre de codigo del plan de Cassius para neutralizar a Oretz y matar a la tripulacion.\nApareció en sus comunicaciones internas y en el manifiesto personal.\nIncluia: incapacitar a Oretz, apagar el soporte vital de forma gradual, borrar evidencias y evacuar.\nEl nombre de PROMETEO era conocido por el nivel ejecutivo del Consorcio Artemis.",
    orion: "ORION-447 es una estacion privada del Consorcio Artemis en orbita geoestacionaria.\nFue el destino de evacuacion de Cassius. Llego ahi 6 horas despues de abandonar Helios-3.\nPasó 6 meses ahi antes de que la sonda Artemis y las autoridades orbitales lo localizaran.\nFue detenido el 14 de julio de 2089. Actualmente en proceso ante el Tribunal de La Haya Espacial.",
    oretz: "La comandante Yael Oretz fue la primera en sospechar del experimento.\nEnvio alertas a Tierra el 10 de enero. La respuesta de Control fue filtrada por el Consorcio.\nDecidio cerrar el experimento manualmente la noche del 13 de enero.\nFue a confrontar a Cassius a las 21:00. No regreso en dos horas. Cassius la incapacito.",
    novak: "Petra Novak fue la primera en detectar la manipulacion de los sensores de O2.\nEl 8 de enero noto que alguien habia subido artificialmente la lectura del modulo 3 en un 5%.\nLo reporto a Oretz el 12 de enero. Juntas intentaron acceder al nucleo de sistemas.\nMurio el 14 de enero junto con el resto de la tripulacion.",
    "0322": "Las 00:22 del 14 de enero es la hora en que Cassius apago el sistema de reciclaje global.\nEn ese momento, toda la estacion empezo a perder O2.\nLos registros muestran que lo hizo 18 minutos despues de que la tripulacion del modulo 3 perdiera la consciencia.\nEsperó a estar seguro antes de apagar el sistema global.",
    helio: "HELIO es el codigo de acceso administrativo de la estacion Helios-3.\nFue compartido por Oretz en su mensaje cifrado a su hija Lyra.\nPermite acceder a todos los logs de administrador de la estacion.\nLos logs muestran el historial completo de accesos de Cassius en los 7 dias previos al crimen.",
    lyra: "Lyra Oretz tenia 9 anos cuando su madre murio.\nVive con su padre en Tel Aviv.\nEl nombre de su hija fue el unico codigo que Oretz uso para cifrar su ultimo mensaje.\nEse mensaje contenia el codigo admin de la estacion: HELIO.",
    dao: "Seren Dao llego a los restos de Helios-3 6 meses despues como parte de la mision de recuperacion.\nFue la primera en ver el orden de los apagados en los logs.\nSu intuicion: un fallo tecnico real empieza por los sistemas mas pequeños. Aqui empezo por los sensores.\nEsa observacion fue lo que convirtio un accidente en una investigacion de homicidio.",
    antidoto: "No existe antidoto conocido para el NTX-7 en dosis elevadas.\nCassius lo sabia. Era una de las razones por las que lo eligio como agente de prueba.\nEn dosis bajas cronicas (como en el experimento) el efecto es reversible si se para la exposicion.\nPero en la concentracion final que Cassius aplico, no habia vuelta atras.",
    "control tierra": "Control Tierra recibio las alertas de Oretz el 11 de enero.\nSu respuesta fue: 'No alteren el experimento sin autorizacion nuestra'.\nEsa respuesta fue redactada bajo influencia del Consorcio Artemis.\nEl operador de turno no sabia lo que estaba diciendo en realidad."
  },
  timeline: [
    ...
    { time: "06/01", event: "Cassius continua el experimento sin autorizacion nueva. NTX-7 en reciclaje.", trigger: "/experimentos/resultados_ocultos.enc" },
    ...
    { time: "12/01", event: "Sintomas neurologicos graves en dos tripulantes del modulo 3. Novak informa a Oretz.", trigger: "/bitacoras/bitacora_general.txt" },
  ...
  databases: {
    ...
    consorcio: {
      ...
      transmision: { text: "Transmision clasificada del Consorcio a Cassius recuperada.", reveal: ["/comunicaciones/transmision_consorcio.txt"] }
    },
    prometeo: {
    ...
    tripulacion: {
      medico: { text: "Registro medico de la tripulacion del modulo 3 recuperado.", reveal: ["/tripulacion/registro_medico_tripulacion.txt"] }
    }
  }
};
